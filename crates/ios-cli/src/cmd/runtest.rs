...
use ios_core::services::apps::{AppInfo, InstallationProxy};
...
use ios_core::services::testmanager::xctestrun::{parse_xctestrun_file, TestConfiguration};
...
pub async fn start_test_plan_session(udid: &str, plan: TestLaunchPlan) -> Result<ActiveTestPlan> {
    ...
    let session_stream = device
        .connect_rsd_service(ios_core::services::testmanager::SERVICE_NAME)
        .await
...
fn infer_target_bundle_id(
    scheme: &ios_core::services::testmanager::xctestrun::SchemeData,
...
mod tests {
    ...
    use clap::Parser;
    use ios_core::services::apps::AppInfo;
    use ios_core::services::testmanager::xctestrun::SchemeData;
    use plist::Value;
