        ...
        match self.sub {
            LocationSub::Set {
                ...
                let mut stream = device
                    .connect_service(ios_core::services::simlocation::SERVICE_NAME)
                    .await?;
                ios_core::services::simlocation::set_location(&mut *stream, &latitude, &longitude)
                    .await
            ...
            LocationSub::Gpx { file } => {
                ...
                let mut stream = device
                    .connect_service(ios_core::services::simlocation::SERVICE_NAME)
                    .await?;
                let count = ios_core::services::simlocation::replay_gpx_route(&mut *stream, &gpx)
                    .await
            ...
            LocationSub::Reset => {
                ...
                let mut stream = device
                    .connect_service(ios_core::services::simlocation::SERVICE_NAME)
                    .await?;
                ios_core::services::simlocation::reset_location(&mut *stream)
                    .await
