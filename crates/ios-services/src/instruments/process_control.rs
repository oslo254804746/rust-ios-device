...
use crate::dtx::types::{DtxPayload, NSObject};
    ...
    pub async fn disable_memory_limit(&mut self, pid: u64) -> Result<bool, DtxError> {
        let msg = self
            ...
            .method_call(
                ...
                &[crate::dtx::primitive_enc::PrimArg::Int32(pid as i32)],
            )
            .await?;
...
mod tests {
    ...
    use super::*;
    use crate::dtx::{encode_dtx, read_dtx_frame, DtxPayload, NSObject};
    ...
    async fn launch_with_options_sends_expected_archived_arguments() {
        ...
        server
            .write_all(&encode_dtx(
                ...
                false,
                MSG_RESPONSE,
                &ios_proto::nskeyedarchiver_encode::archive_int(4242),
                &[],
            ))
            .await
            .unwrap();
    ...
    async fn disable_memory_limit_treats_integer_response_as_boolean() {
        ...
        server
            .write_all(&encode_dtx(
                ...
                false,
                MSG_RESPONSE,
                &ios_proto::nskeyedarchiver_encode::archive_int(1),
                &[],
            ))
            .await
            .unwrap();
