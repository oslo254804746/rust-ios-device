...
fn entry_to_nsobject(type_tag: u32, value: Bytes) -> NSObject {
    match type_tag {
        ...
        PRIMITIVE_BYTES => match ios_proto::nskeyedarchiver::unarchive(&value) {
...
fn archive_to_ns(val: ios_proto::nskeyedarchiver::ArchiveValue) -> NSObject {
...
mod tests {
    ...
    use super::*;
    use crate::dtx::primitive_enc::{encode_primitive_dict, PrimArg};
    ...
    fn decode_auxiliary_roundtrips_encoded_archived_bytes() {
        let archived = ios_proto::nskeyedarchiver_encode::archive_string("hello");
