    ...
    match msg_type {
        ...
        MSG_METHOD_INVOCATION => {
            ...
            let selector = if payload.is_empty() {
                ...
                match ios_proto::nskeyedarchiver::unarchive(&payload)
                    .ok()
        ...
        MSG_RESPONSE | MSG_ERROR => {
            if payload.is_empty() {
                ...
                let obj = ios_proto::nskeyedarchiver::unarchive(&payload)
                    .map(archive_to_ns)
...
fn archive_to_ns(v: ios_proto::nskeyedarchiver::ArchiveValue) -> NSObject {
